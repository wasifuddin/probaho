    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <img src="/images/probaho_logo.png" alt="Pure drop Logo" className="h-8 w-auto mr-3" />
              <span className="text-2xl font-bold text-blue-600">Pure drop</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-white p-8 rounded-2xl shadow-2xl">
                <img src="/images/product_image.jpg" alt="Pure drop tube purifier prototype" className="w-full h-96 object-contain rounded-xl" />
                <p className="text-center text-sm text-gray-500 mt-4">Pure drop tube purifier prototype</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="solution" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8">Why Pure drop</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-6 md:mb-0 group">
              ...
              <p className="text-gray-400 ml-4 group-hover:text-white transition-colors duration-300">© {new Date().getFullYear()} Pure drop – Flowing Purity</p>
            </div>
